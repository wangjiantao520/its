...
export const SURVEY_QUESTIONS: SurveyQuestion[] = [
  ...
  // ===== 二、维保范围 =====
  {
    ...
    type: 'text',
    required: true,
    placeholder: '请输入设备类型，如台式电脑、电动装订机等',
  },
  {
    id: 'scope-002',
    section: SURVEY_SECTIONS.MAINTENANCE_SCOPE,
  ...
  {
    id: 'req-001',
    section: SURVEY_SECTIONS.MAINTENANCE_REQUIREMENTS,
    order: 1,
    question: '巡检频率',
    type: 'select',
    required: true,
    options: [
      { label: '每月一次', value: '每月' },
      { label: '每季度一次', value: '每季度' },
      { label: '每半年一次', value: '每半年' },
      { label: '每年一次', value: '每年' },
    ],
  },
  {
