...
export const deviceParamsUpdateSchema = z.discriminatedUnion('type', [
  z.object({
    ...
    data: z.object({
      ...
      level: optionalNullableString, engineer_level: optionalNullableString,
      ...
      spare_part_fee: optionalNullableNumber, city_price: optionalNullableNumber,
      urban_price: optionalNullableNumber, town_price: optionalNullableNumber,
      rural_price: optionalNullableNumber, year1_total_price: optionalNullableNumber,
      year2_total_price: optionalNullableNumber, year3_total_price: optionalNullableNumber,
      core_maintenance_content: optionalNullableString, sort_order: optionalNullableInteger,
