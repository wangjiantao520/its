...
const ROLE_PATHS: Record<UserRole, string[]> = {
  ...
  'admin': ['/', '/dashboard', '/engineering', '/quotes', '/maintenance', '/survey-upload', '/data', '/history', '/database', '/clients', '/reports', '/assistant', '/admin', '/admin/users', '/admin/ai-config', '/admin/agents', '/admin/dashboard', '/admin/members', '/admin/quote-library', '/device-review', '/settings/ai-models', '/quote-library']
};
